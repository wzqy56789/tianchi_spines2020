...
class Config(object):
    ...
    # Only useful if you supply a call able to BACKBONE. Should compute
    ...
    # Length of square anchor side in pixels针对小图像，调小了些
    ...
    #MEAN_PIXEL = np.array([123])#灰度图，白色为255，黑色为0
    MEAN_PIXEL = np.array([0])  # 灰度图
